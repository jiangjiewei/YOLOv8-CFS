...
parser.add_argument('--data', metavar='DIR', default="/home/jiangjiewei/dingke_gpu/data_test6567/nocropped",
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    #criterion = nn.CrossEntropyLoss(weight=torch.Tensor([0.9, 1.0, 3.0])).cuda(args.gpu)
    # use_cuda = True
    ...
    train_dataset = datasets.ImageFolder(
        ...
        transforms.Compose([
            ...
            transforms.Resize((args.image_size, args.image_size), interpolation=PIL.Image.Resampling.BICUBIC),
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.arch.find('alexnet') != -1:
            ...
            pre_name = '//home/jiangjiewei/dingke_gpu/classifier_patch/encoding/inception_v3_1024'
        elif args.arch.find('densenet121') != -1:
            pre_name = '/home/jiangjiewei/dingke_gpu/classifier_patch/models_ori/densenet121_w113_e20'
        elif args.arch.find('resnet101') != -1:
            pre_name = '/home/jiangjiewei/dingke_gpu/classifier_patch/models_ori/resenet101/resnet'
        else:
...
def fundus_test():
    ...
    #                   ]
    #
    # # dataset_dir = '../../../../dataset/heatmap_fundus'
    #
    ...
    for index_name in range(0,len(model_names)):
        args.arch = model_names[index_name]
        for i in range(0,len(dataset_subdir)):
            dataset_dir = '/home/jiangjiewei/dingke_gpu/data_test6567/nocropped/test'
            #resultset_dir = './result_slit_lamp/' + dataset_subdir[i]
            #resultset_dir = './result_by_ori_model/result_slit_lamp/'
            resultset_dir = '/home/jiangjiewei/dingke_gpu/classifier_patch/results/ori_model_w113/NEH/resnet101'
            args, model, val_transforms = load_modle_trained(args)
            mk_result_dir(args, resultset_dir)
            fundus_test_exec(args, model, val_transforms, dataset_dir,resultset_dir)
...
def load_modle_trained(args):
    ...
    PATH='/home/jiangjiewei/dingke_gpu/classifier_patch/models_ori/resenet101/resnet_model_best.pth.tar'
    ...
    if args.arch.find('alexnet') == -1:
        #model = model.cuda()  #for modles trained by multi GPUs: densenet inception_v3 resnet50
        model = torch.nn.DataParallel(model).cuda()
